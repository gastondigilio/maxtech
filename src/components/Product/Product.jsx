...
// import ImgLeft from "../assets/Product/logoSilande.png";
// import ImgCenter1 from "../assets/Product/logoSilande.png";
// import ImgCenter2 from "../assets/Product/homeryLogo.png";
// import ImgCenter3 from "../assets/Product/logoSilande.png";
// import ImgRight from "../assets/Product/logoSilande.png";
...
//                                 <img src={ImgLeft} className="card-img-top" alt="Imagen Izquierda" />
//                                 <ul className="list-unstyled">
//                                     <li>Fibras sintéticas para hormigón</li>
//                                     <li>Mallas de fibra de vidrio</li>
//                                     <li>Cinta autoadhesiva de fibra de vidrio</li>
//                                     <li>Selladores de poliuretano</li>
//                                     <li>Selladores de polímeros modificados</li>
//                                     <li>Membrana líquida, base acrílico & poliuretánica</li>
//                                     <li>Anclajes químicos</li>
//                                     <li>Aplicadores, manuales, neumáticos y a batería</li>
//                                     <li>Clavos, tornillos</li>
//                                     <li>Máquinas y equipos para la construcción y mantenimiento</li>
//                                 </ul>
//                             </div>
//                         </div>
//                     </div>
...
//                             <div className="card-body">
//                                 <h5 className="card-title text-center">Producto Central</h5>
//                                 <div className="row">
//                                     <div className="col-4">
//                                         <img src={ImgCenter1} className="img-fluid" alt="Imagen Central 1" />
//                                         <ul className="list-unstyled">
//                                             <li>Fibras sintéticas para hormigón</li>
//                                             <li>Mallas de fibra de vidrio</li>
//                                             <li>Cinta autoadhesiva de fibra de vidrio</li>
...
//                                     </div>
//                                     <div className="col-4">
//                                         <img src={ImgCenter2} className="img-fluid" alt="Imagen Central 2" />
//                                     </div>
//                                     <div className="col-4">
//                                         <img src={ImgCenter3} className="img-fluid" alt="Imagen Central 3" />
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
...
//                         <div className="card">
//                             <div className="card-body">
//                                 <h5 className="card-title">Producto Derecha</h5>
//                                 <img src={ImgRight} className="card-img-top" alt="Imagen Derecha" />
//                                 <ul className="list-unstyled">
//                                     <li>Fibras sintéticas para hormigón</li>
//                                     <li>Mallas de fibra de vidrio</li>
//                                     <li>Cinta autoadhesiva de fibra de vidrio</li>
...
//                         <div className="card">
//                             <div className="card-body">
//                                 <h5 className="card-title">Industrias</h5>
//                                 <img src={ImgRight} className="card-img-top" alt="Imagen Derecha" />
//                                 <ul className="list-unstyled">
//                                     <li>Adhesivos termofusion para packaging aprobación FDA</li>
//                                 </ul>
//                             </div>
//                         </div>
//                     </div>
...
//                 {/* Columna Central con Imágenes */}
//                 <div className="row">
//                     <div className="col-md-12 mb-4">
//                         <div className="card h-100">
//                             <div className="card-body">
//                                 <h5 className="card-title text-center">Aberturas</h5>
//                                 <div className="row">
//                                     <div className="col-4">
//                                         <img src={ImgCenter1} className="img-fluid" alt="Imagen Central 1" />
//                                         <ul className="list-unstyled">
//                                             <li>Perfiles estructurales</li>
//                                             <li>Perfiles espaciadores</li>
//                                             <li>Cinta bi faz, base EVA FOAM y BUTILO</li>
//                                             <li>Espaciadores WARM EDGE</li>
//                                             <li>Disecante, tamiz molecular</li>
//                                             <li>Vidrios para MURO CORTINA</li>
//                                         </ul>
//                                     </div>
//                                     <div className="col-4">
//                                         <img src={ImgCenter2} className="img-fluid" alt="Imagen Central 2" />
